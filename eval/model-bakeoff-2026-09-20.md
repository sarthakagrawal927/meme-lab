...
1. **300 → 3,000 memes:** enrich metadata, retrieve 30, score with Jev fast, then use the generative model to produce complete sentence explanations and handle uncertain cases.
