...
const coverageEvalSummary=validateStageCoverageCases(coverageCases,{allowedIds:new Set(candidates.map(record=>record.id)),excludedIds:[...catalogue,...candidates.slice(0,30)].map(record=>record.id)});
