...
await Promise.all([
  writeFile(resolve(root,'eval/results/stage-300-coverage.json'),`${JSON.stringify(report,null,2)}\n`),
  writeFile(resolve(root,'eval/stage-300-coverage-summary.json'),`${JSON.stringify(summary,null,2)}\n`)
]);
